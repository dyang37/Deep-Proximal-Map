...
def cnnModel():
  ...
  yAv = layers.Conv2D(20,3,data_format='channels_first',activation='relu')(input_yAv) #20x5200
  yAv = layers.Conv2D(40,3,data_format='channels_first',activation='relu')(yAv) #40x5200
  yAv = layers.MaxPooling1D(data_format='channels_first',pool_size=2)(yAv) #40x2600
  yAv = layers.Conv2D(80,3,data_format='channels_first',activation='relu')(yAv) #80x2600
  yAv = layers.MaxPooling1D(data_format='channels_first',pool_size=2)(yAv) #80x1300
  yAv = layers.Conv2D(360,3,data_format='channels_first',activation='relu')(yAv) #360x1300
  yAv = layers.MaxPooling1D(data_format='channels_first',pool_size=5)(yAv) #360x260
  yAv2D = layers.Reshape((1,360,260))(yAv) #1x360x260 
  yAv2D = layers.Conv2D(32,(3,3),data_format='channels_first',activation='relu')(yAv2D) #32x360x260
  yAv2D = layers.Conv2D(32,(3,3),data_format='channels_first',activation='relu')(yAv2D) #32x360x260
  
  v = layers.Conv2D(32,(3,3),data_format='channels_first',activation='relu')(input_v) #32x360x260
  v = layers.Conv2D(32,(3,3),data_format='channels_first',activation='relu')(v) #32x360x260
  v = layers.Conv2D(32,(3,3),data_format='channels_first',activation='relu')(v) #32x360x260
  
  H = layers.Concatenate(axis=1)([v,yAv2D]) #64x360x260
  H = layers.Conv2D(32,(3,3),data_format='channels_first',activation='relu')(H)
  H = layers.Conv2D(16,(3,3),data_format='channels_first',activation='relu')(H)
  H = layers.Conv2D(8,(3,3),data_format='channels_first',activation='relu')(H)
  H = layers.Conv2D(4,(3,3),data_format='channels_first',activation='relu')(H)
  H_prev = layers.Conv2D(2,(3,3),data_format='channels_first',activation='relu')(H) #2x360x260
