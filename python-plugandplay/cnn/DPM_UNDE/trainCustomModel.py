...
model_name = "UNDE_resnet_lossless_1.22_looped3000_gaussian3000"
######## load pre-generated training data
filepath = '/scratch/gilbreth/yang1467/UNDE/lossless/LosslessDiskdata-sig0.1-2chann.mat'
...
filepath = '/scratch/gilbreth/yang1467/UNDE/lossless/LosslessDiskdata-Loopdiff-0.1var-zero-disk-2chann.mat'
data = h5py.File(filepath, 'r')
y_Av_train1 = np.transpose(data["yAv_dict"], (2,1,0))
y_Av_train1 = y_Av_train1[:3000,:,:]
v_train1 = np.transpose(data["v_dict"], (3,0,2,1))
v_train1 = v_train1[:3000,:,:,:]
epsil_train1 = np.transpose(data["eps_dict"], (3,0,2,1))
epsil_train1 = epsil_train1[:3000,:,:,:]
