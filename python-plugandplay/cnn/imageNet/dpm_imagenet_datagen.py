...
dataset_dir = '/root/datasets/Data/DET/train/'
dict_name = '/root/datasets/DPM_VGG16_train1000.dat'
...
for root,_,_ in os.walk(dataset_dir):
  filepool = np.concatenate([filepool,glob.glob(os.path.join(root,"*.JPEG"))])
