...
H_4D = layers.Conv2D(1,(3,3),activation='relu',padding='same',data_format='channels_first')(H_4D)
H_out = layers.Conv2D(1,(3,3),activation='sigmoid',padding='same',data_format='channels_first')(H_4D)
